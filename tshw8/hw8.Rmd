...
sig[2,2]=0.25^2
sig[3,3]=0.18^2
sig[1,2]=0.3*0.2*0.25
sig[2,1]=sig[1,2]
sig[2,3]=0.3*0.25*0.18
sig[3,2]=sig[2,3]
sig[1,3]=0.4*0.2*0.18
sig[3,1]=0.4*0.2*0.18
M=cbind(mu,1)
B=t(M)%*%solve(sig)%*%M
m0_tu_1=c(0.02,1)
m0_tu_2=c(0.15,1)
...
opt_1=(1-alp_1[1,1])*((solve(sig)%*%c(1,1,1))/(t(c(1,1,1))%*%solve(sig)%*%c(1,1,1))[1,1])+alp_1[1,1]*((solve(sig)%*%mu)/(t(mu)%*%solve(sig)%*%c(1,1,1))[1,1])
opt_2=(1-alp_2[1,1])*((solve(sig)%*%c(1,1,1))/(t(c(1,1,1))%*%solve(sig)%*%c(1,1,1))[1,1])+alp_2[1,1]*((solve(sig)%*%mu)/(t(mu)%*%solve(sig)%*%c(1,1,1))[1,1])
